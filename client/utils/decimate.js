...
export const decimateString = (text, rate = 10, hideHardSpace = false) => {
    ...
    for (let i = 0; i < text.length; i++) {
        ...
        const value = char.match(/\d/) ?
            Number(char) :
            10
        decimatedText += value < rate ?
            '_' :
            text[i]
    }
...
export function buildDecimationLevelArrays(stringPassage, levels = 10, hideHardSpace) {
