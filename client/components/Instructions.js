...
const Instructions = () => {
  ...
  const passageTips = [
    'Start practising by slowly reading your passage a few times. Then increase the difficulty level',
    'To change the difficulty level - move the fader or use Arrow keys Left and Right.',
    'If the box in the top right coner is not checked places of removed letters will be marked.'
  ]
