...
import { Login, Signup, Profile, Training, LandingPage, PassageForm, GraphWrapper, BrowsePassages, TestingGraphView } from './components'
  ...
  render() {
    ...
    return (
      <Switch>
        ...
        <Route path="/stats" component={TestingGraphView} />
